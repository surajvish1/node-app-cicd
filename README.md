...
This project demonstrates a simple CI/CD pipeline for a Node.js app using GitLab with a self-hosted runner on an EC2 instance.

## Project Overview

1. **Created a simple Node.js app** (`server.js`) that listens on port 8080.
...
```
cd existing_repo
git remote add origin https://gitlab.com/knovator-project/knovator-cicd.git
git branch -M main
